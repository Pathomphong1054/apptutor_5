...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _fetchProfileData() async {
    ...
    try {
      final url = Uri.parse(
          'http://192.168.243.173/tutoring_app/get_${widget.userRole}_profile.php?username=${widget.username}');
  ...
  Future<void> _uploadProfileImage(File imageFile) async {
    try {
      var request = http.MultipartRequest(
        'POST',
        Uri.parse(
            'http://192.168.243.173/tutoring_app/upload_profile_${widget.userRole}.php'),
      );
      request.files.add(
    ...
    if (_profileImage != null) {
      ...
      try {
        var response = await http.post(
          Uri.parse(
              'http://192.168.243.173/tutoring_app/update_${widget.userRole}_profile.php'),
          body: {
